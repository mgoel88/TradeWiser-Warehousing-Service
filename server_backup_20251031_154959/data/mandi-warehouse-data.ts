...
export const panIndiaMandiWarehouses: MandiWarehouse[] = [
  ...
  },
  {
    ...
    primaryCommodities: ["Bajra", "Mustard", "Gram", "Guar"],
    warehouseType: "primary_market",
    capacity: 14000,
    latitude: 28.0229,
    longitude: 73.3119,
  ...
  },
  {
    ...
    hasGodownFacilities: true,
    hasColdStorage: false,
    phoneNumber: "0291-2345678",
    primaryCommodities: ["Cotton", "Cumin", "Coriander", "Bajra"],
    warehouseType: "terminal_market",
    capacity: 16000,
    latitude: 26.2389,
    longitude: 73.0243,
  ...
  },
  {
    ...
    state: "Rajasthan",
    regulationStatus: "regulated",
    nearestRailwayStation: "Kota Junction",
    railwayDistance: 3,
    hasGodownFacilities: true,
    hasColdStorage: true,
    phoneNumber: "0744-2345678",
    primaryCommodities: ["Wheat", "Mustard", "Coriander", "Soybean"],
    warehouseType: "terminal_market",
    capacity: 20000,
    latitude: 25.2138,
    longitude: 75.8648,
  ...
  },
  {
    ...
    state: "Rajasthan",
    regulationStatus: "regulated",
    nearestRailwayStation: "Alwar Junction",
    railwayDistance: 2,
    hasGodownFacilities: true,
    hasColdStorage: false,
    phoneNumber: "0144-2345678",
    primaryCommodities: ["Wheat", "Mustard", "Barley", "Gram"],
    warehouseType: "primary_market",
    capacity: 12000,
    latitude: 27.5530,
    longitude: 76.6346,
  ...
  },
  {
    ...
    state: "Rajasthan",
    regulationStatus: "regulated",
    nearestRailwayStation: "Sikar Junction",
    railwayDistance: 1,
    hasGodownFacilities: true,
    hasColdStorage: false,
    phoneNumber: "01572-234567",
    primaryCommodities: ["Mustard", "Gram", "Bajra", "Cumin"],
    warehouseType: "primary_market",
    capacity: 10000,
    latitude: 27.6094,
    longitude: 75.1399,
  ...
  },
  {
    ...
    state: "Rajasthan",
    regulationStatus: "regulated",
    nearestRailwayStation: "Udaipur City",
    railwayDistance: 3,
    hasGodownFacilities: true,
    hasColdStorage: true,
    phoneNumber: "0294-2345678",
    primaryCommodities: ["Wheat", "Maize", "Mustard", "Cotton"],
    warehouseType: "terminal_market",
    capacity: 15000,
    latitude: 24.5854,
    longitude: 73.7125,
